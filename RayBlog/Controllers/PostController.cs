...
namespace RayBlog.Api.Controllers
{
    ...
    public class PostController : Controller
    {
        ...
        [RequestHeaderMatchingMediaType("Accept", new[] { "application/vnd.whx.hateoas+json" })]
        ...
        [RequestHeaderMatchingMediaType("Content-Type", new[] { "application/vnd.whx.post.create+json" })]
        [RequestHeaderMatchingMediaType("Accept", new[] { "application/vnd.whx.hateoas+json" })]
        ...
        [RequestHeaderMatchingMediaType("Content-Type", new[] { "application/vnd.whx.post.update+json" })]
